        ...
        <div class="w-full lg:w-8/12 px-4 mx-auto mt-6">
            <div
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <form method="POST" action="{{ route('barang.submit') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex flex-wrap">
                                ...
                                <div class="relative w-full mb-3">
                                    ...
                                    <select name="kondisi_barang" id="kondisi_barang"
                                        ...
                                        @foreach ($kondisi_barang as $kondisi)
                                            <option value="{{ $kondisi->kondisi_barang }}">{{ $kondisi->kondisi_barang }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="w-full px-4">
                                <div class="relative w-full mb-3">
                                    <label class="block uppercase text-black text-xs font-bold mb-2" htmlfor="keterangan">
                                        Keterangan
                                    </label>
